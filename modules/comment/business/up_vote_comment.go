...
func (biz *commentBusiness) UpVote(ctx context.Context, cmtId string, userId string) (*entity.Comment, error) {
	...
	if cmt.ParentCommentId != nil {
		return nil, common.NewCustomBadRequestError("Cannot upvote for a reply")
	}
