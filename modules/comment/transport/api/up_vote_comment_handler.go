...
func (hdl *commentHandler) UpVote(appCtx appctx.AppContext) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		cmt, err := hdl.business.UpVote(c.Request.Context(), params.CommentId, requester.GetUserId())
		if err != nil {
			panic(err)
		}
